...
parser.add_argument('--model_name', type=str, default='MambaSR', help="model name")
...
parser.add_argument('--path_for_train', type=str, default='/hy-tmp/LFSR_dataset/data_for_training/')
parser.add_argument('--path_for_test', type=str, default='/hy-tmp/LFSR_dataset/data_for_test/')
...
parser.add_argument("--n_groups", type=int, default=1, help="number of HLFSR-Groups")
